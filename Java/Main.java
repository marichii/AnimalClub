...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    if (gameMode.equalsIgnoreCase("play")) {
      ...
      System.out.println("Blaze" + "\t" + "Enderman" + "\t" + "Glare" + "\t" + "Golem" + "\t" + "Skeleton" + "\t"
          + "Slime" + "\t" + "Spider" + "\t" + "Zombie");
      ...
      Game.game(environments[random.nextInt(3)], characterItem, Character, items[random.nextInt(4)],
          mobs[random.nextInt(7)]);
    }
  }
}